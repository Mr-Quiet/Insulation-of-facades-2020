const emailRegExp = new RegExp(/^[a-zA-Z0-9.]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/),
	  nameRegExp = new RegExp(/^[а-яА-Яа-яА-ЯїЇіІa-zA-Z ]{2,30}$/),
...
const emailInput = document.getElementById("email-input"),
	fioInput = document.getElementById("fio-input"),
	phoneInput = document.getElementById("phone-input"),
	dateInput = document.getElementById("date-input"),
	timeInput = document.getElementById("time-input");

let emailErrorMessage = document.getElementById('email-error-message'),
	fioErrorMessage = document.getElementById('fio-error-message'),
